...
variable "external_key" {
  default = "-----BEGIN RSA PRIVATE KEY-----MIIBigKCAYEAq3DnhgYW7yWGjXPqy/ZJ/+-----END RSA PRIVATE KEY-----"
  #default = file("/home/dozee/.ssh/external_key.pub")
}
variable "private_internal_key" {
  default = "-----BEGIN RSA PRIVATE KEY-----MIIBigKCAYEAq3DnhgYW7yWGjXPqy/ZJ/+-----END RSA PUBLIC KEY-----"
